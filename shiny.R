...
ui <- fluidPage(
  ...
  ,
  # Upload Image Button
  absolutePanel(wellPanel(actionButton(icon=NULL, inputId="upload_Button ", width=100, label="Upload Photo")),   top=200, height=200, left=2300, width=150),
  
  # Next Image Button
  absolutePanel(wellPanel(actionButton(icon=NULL, inputId="next_Button"   , width=100, label="Next Image")),     top=300, height=200, left=2300, width=150),
  
  # Previous Image Button
  absolutePanel(wellPanel(actionButton(icon=NULL, inputId="prev_Button"   , width=100, label="Previous Image")), top=400, height=200, left=2300, width=150),
  
  # Missing Point Button
  absolutePanel(wellPanel(actionButton(icon=NULL, inputId="missing_Button", width=100, label="Missing point")),  top=500, height=200, left=2300, width=150),
